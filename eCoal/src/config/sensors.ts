...
export const sensorMappings: SensorMapping[] = [
  ...
  },
  {
    ...
    {
    name: "pump_3",
    mqttUniqueId: "sensor_pump_3",
    tid: "ob3_out_pump",
    type: "state",
  },
    {
    name: "pump_4",
    mqttUniqueId: "sensor_pump_4",
    tid: "ob4_out_pump",
    type: "state",
  },
    {
    name: "pump_cwu",
    mqttUniqueId: "sensor_pump_cwu",
    tid: "out_cwu",
    type: "state",
  },
  {
...
export const temperatureControlMappings: TemperatureControlMapping[] = [
  ...
  },
  {
    ...
    setId: "ob3_tzad",
    readoutId: "t3_value",
    currentSetValueId: "ob3_zaw4d_tzad",
    unit: "°C",
    minValue: 10,
    maxValue: 70,
  },
    {
    name: "circuit_4_valve_setpoint",
    mqttUniqueId: "control_circuit_4_valve_setpoint",
    setId: "ob4_tzad",
    readoutId: "t4_value",
    currentSetValueId: "ob4_zaw4d_tzad",
    unit: "°C",
    minValue: 10,
    maxValue: 70,
  },
